 ...
 * @Last Modified time: 2020-06-09 15:33:54
 */
...
renderData.views.push({
  ...
  events: {
    tapped: function(sender) {
      $http.get({
        // mock
        // url: "https://www.fastmock.site/mock/b4a46c87101afae11fcf7ef792ddfe90/alog/getData?" + Helper.param(search),
        url: "http://alog.frostbelt.cn/getData?" + Helper.param(search),
